...
public class YourHW4Tests {
	...
	public void testDelete() throws Exception {
		...
		//if insert is right, begin the deletion
	...
	public void testGetLock() throws Exception {
	    bp.getPage(0, tid, 0, Permissions.READ_WRITE); // does not release lock here
	    
	    bp.getPage(1, tid, 0, Permissions.READ_WRITE);
		bp.transactionComplete(1, true);
	    assertFalse(false); //will only reach this point if locks are not gotten in the first part
